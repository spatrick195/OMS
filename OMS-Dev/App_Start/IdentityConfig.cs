...
namespace OMS_Dev
{
    ...
    public class ApplicationEmployeeManager : UserManager<Employee>
    {
        ...
        // configure custom identity class
        public static ApplicationEmployeeManager Create(IdentityFactoryOptions<ApplicationEmployeeManager> options, IOwinContext context)
        {
            var manager = new ApplicationEmployeeManager(new UserStore<Employee>(context.Get<ApplicationDbContext>()));
            // Configure validation logic for usernames
    ...
    public class EmployeeSignInManager : SignInManager<Employee, string>
    {
        ...
        {
            return user.GenerateUserIdentityAsync((ApplicationEmployeeManager)UserManager);
        }

        public static EmployeeSignInManager Create(IdentityFactoryOptions<EmployeeSignInManager> options, IOwinContext context)
        {
            return new EmployeeSignInManager(context.GetUserManager<ApplicationEmployeeManager>(), context.Authentication);
        }
    }
}